...
Routes.add(new RegionRoute(
    ...
    new RoutePokemon({
        ...
        special:
        [
            new SpecialRoutePokemon(['Bounsweet', 'Vespiquen', 'Combee', 'Minccino', 'Mudsdale', 'Pangoro', 'Roselia'], [new WeatherRequirement([WeatherType.Clear])]),
            new SpecialRoutePokemon(['Budew', 'Oddish', 'Ralts', 'Mudsdale', 'Pangoro', 'Roselia'], [new WeatherRequirement([WeatherType.Overcast])]),
            new SpecialRoutePokemon(['Lotad', 'Nuzleaf', 'Pelipper', 'Haunter', 'Pangoro', 'Wingull', 'Roselia'], [new WeatherRequirement([WeatherType.Rain])]),
            new SpecialRoutePokemon(['Joltik', 'Pikachu', 'Manectric', 'Electrike', 'Haunter', 'Pangoro', 'Wingull'], [new WeatherRequirement([WeatherType.Thunderstorm])]),
            new SpecialRoutePokemon(['Minccino', 'Piloswine', 'Vanillite', 'Roselia'], [new WeatherRequirement([WeatherType.Snow])]),
            new SpecialRoutePokemon(['Snorunt', 'Mime Jr.', 'Delibird', 'Piloswine', 'Vanillite'], [new WeatherRequirement([WeatherType.Blizzard])]),
            new SpecialRoutePokemon(['Vulpix', 'Growlithe', 'Mudbray', 'Mudsdale', 'Pangoro', 'Roselia'], [new WeatherRequirement([WeatherType.Sunny])]),
            new SpecialRoutePokemon(['Natu', 'Kirlia', 'Gardevoir', 'Munna', 'Ralts', 'Mudsdale', 'Roselia'], [new WeatherRequirement([WeatherType.Fog])]),
            new SpecialRoutePokemon(['Golett', 'Crustle', 'Dwebble', 'Baltoy', 'Mudsdale', 'Roselia'], [new WeatherRequirement([WeatherType.Sandstorm])]),
        ],
    }),
