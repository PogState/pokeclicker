...
Routes.add(new RegionRoute(
    ...
    new RoutePokemon({
        ...
        [
            ...
            new SpecialRoutePokemon(['Natu', 'Kirlia', 'Gardevoir'], [new WeatherRequirement([WeatherType.Fog])]),
            new SpecialRoutePokemon(['Lotad', 'Nuzleaf'], [new WeatherRequirement([WeatherType.Rain])]),
            new SpecialRoutePokemon(['Snorunt', 'Mime Jr.', 'Delibird'], [new WeatherRequirement([WeatherType.Blizzard])]),
            ...
            new SpecialRoutePokemon(['Joltik', 'Pikachu', 'Manectric', 'Electrike'], [new WeatherRequirement([WeatherType.Thunderstorm])]),
            new SpecialRoutePokemon(['Golett', 'Crustle'], [new WeatherRequirement([WeatherType.Sandstorm])]),
            new SpecialRoutePokemon(['Bounsweet', 'Vespiquen'], [new WeatherRequirement([WeatherType.Clear])]),
        ],
    }),
